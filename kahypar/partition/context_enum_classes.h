...
enum class RefinementAlgorithm : uint8_t {
  ...
  kway_fm,
  kway_fm_km1,
  flow_balancing_kway_fm_km1,
  rebalancing_kway_fm_km1,
...
static std::ostream& operator<< (std::ostream& os, const RefinementAlgorithm& algo) {
  switch (algo) {
    ...
    case RefinementAlgorithm::flow_balancing_kway_fm_km1: return os << "flow_balancing_kway_fm_km1";
    case RefinementAlgorithm::rebalancing_kway_fm_km1: return os << "rebalancing_kway_fm_km1";
